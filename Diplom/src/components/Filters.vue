<template>
  ...
  <fieldset class="filter">
    ...
    <div class="filter_inputs">
      ...
      <input type="text" v-model="expeditorFilter.input" 
      :disabled="!expeditorFilter.enabled" 
      placeholder="Введите"
      class="filter_input"></input>
    </div>
  </fieldset>
  ...
  <fieldset class="filter">
    ...
    <div class="filter_inputs">
      ...
      <input type="text" v-model="cargoNameFilter.input" 
      :disabled="!cargoNameFilter.enabled" 
      placeholder="Введите"
      class="filter_input"></input>
    </div>
  </fieldset>
  ...
  <fieldset class="filter">
    ...
    <div class="filter_inputs">
      ...
      <input type="text" v-model="clientFilter.input" 
      :disabled="!clientFilter.enabled" 
      placeholder="Введите"
      class="filter_input"></input>
    </div>
  </fieldset>
